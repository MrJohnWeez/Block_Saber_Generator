...
setblock ~ ~-4 ~ minecraft:structure_block[mode=load]{mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,rotation:"NONE",posX:0,mode:"LOAD",posY:5,sizeX:1,posZ:3,integrity:1.0f,showair:0b,name:"_root_class:warning_sign",sizeY:1,sizeZ:2,showboundingbox:0b}
