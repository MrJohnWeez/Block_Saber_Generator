...
execute at @e[type=armor_stand,tag=playerOrgin] as @p[scores={SongUUID=1111}] run function block_saber_base:spawn_notes_base
...
execute at @e[type=armor_stand,tag=playerOrgin] as @p[scores={SongUUID=1111}] run function block_saber_base:give_sabers
