...
execute at @e[type=armor_stand,tag=playerOrgin] run summon armor_stand ~ ~1.5 ~-3 {Tags:[nodeSpawnOrgin,blockBeat],DisabledSlots:4096,Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1b,Small:1b}
