...
execute at @e[type=armor_stand,tag=playerOrgin] run summon armor_stand ~ ~1 ~-7 {Tags:[nodeSpawnOrgin,blockBeat],DisabledSlots:4096,Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1b,Small:1b}
...
execute at @s run summon armor_stand ~ ~1.0 ~ {Tags:[MidBlockHeight,temp,blockBeat],DisabledSlots:4096,Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1b,Small:1b}
execute at @s run summon armor_stand ~ ~0.2 ~ {Tags:[LowBlockHeight,temp,blockBeat],DisabledSlots:4096,Invisible:1b,NoGravity:1b,Marker:1b,Invulnerable:1b,Small:1b}
...
execute at @e[type=armor_stand,tag=nodeSpawnOrgin] run teleport @e[type=armor_stand,tag=nodeCursor] ~0.4 ~ ~
