...
setblock ~-2 ~-2 ~ minecraft:structure_block[mode=load]{mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,rotation:"NONE",posX:0,mode:"LOAD",posY:1,posZ:-3,integrity:1.0f,name:"minecraft:testing_again",showboundingbox:0b}